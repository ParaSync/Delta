...
export const PropertiesPanel: React.FC<PropertiesPanelProps> = ({
  ...
  const updateLabel = (label: string) => {
    ...
    if (selectedNode.key && ['text', 'textarea', 'number', 'date', 'time', 'datetime', 'select', 'multiselect', 'radio', 'checkbox', 'file', 'table'].includes(selectedNode.type)) {
  ...
  const addOption = () => {
    ...
    updateProps({ options: [...currentOptions, newOption] });
  };
  ...
  const renderCommonProperties = () => (
    <>
      <div className="space-y-4">
        ...
        {/* Label/Text */}
        {(selectedNode.props.hasOwnProperty('label') || selectedNode.props.hasOwnProperty('text')) && (
          <div className="space-y-2">
            <Label htmlFor="element-label">
              {selectedNode.props.hasOwnProperty('label') ? 'Label' : 'Text'}
            </Label>
            <Input
              id="element-label"
              value={selectedNode.props.label || selectedNode.props.text || ''}
              onChange={(e) => {
                if (selectedNode.props.hasOwnProperty('label')) {
        ...
        {/* Placeholder */}
        {selectedNode.props.hasOwnProperty('placeholder') && (
          <div className="space-y-2">
        ...
        {/* Required Toggle */}
        {['text', 'textarea', 'number', 'date', 'time', 'datetime', 'select', 'multiselect', 'radio', 'checkbox', 'file'].includes(selectedNode.type) && (
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateProps({ min: e.target.value ? parseFloat(e.target.value) : undefined })}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateProps({ max: e.target.value ? parseFloat(e.target.value) : undefined })}
                />
              </div>
            </div>
            <div className="space-y-2">
